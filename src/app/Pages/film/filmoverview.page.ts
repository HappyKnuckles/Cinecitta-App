...
import { ActionSheetController, IonContent, IonModal, IonBackdrop, IonText, IonHeader, IonToolbar, IonButton, IonIcon, IonTitle, IonButtons, IonGrid, IonRow, IonCol, IonSelect, IonSelectOption, IonLabel, IonDatetime, IonFooter, IonRefresher, IonImg, IonPopover } from '@ionic/angular/standalone';
...
@Component({
    ...
    standalone: true,
    imports: [NgIf, IonBackdrop, IonText, IonHeader, IonToolbar, IonButton, IonIcon, IonTitle, SearchComponent_1, IonModal, IonButtons, IonContent, IonGrid, NgFor, IonRow, IonCol, IonSelect, FormsModule, IonSelectOption, IonLabel, NgStyle, NgClass, IonDatetime, IonFooter, IonRefresher, IonImg, IonPopover, ExtractTextPipe, TransformTimePipe]
})
