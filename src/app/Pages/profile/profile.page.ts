...
import { IonModal, IonHeader, IonToolbar, IonTitle, IonContent, IonRefresher, IonThumbnail, IonImg, IonIcon, IonGrid, IonRow, IonCol, IonButtons, IonButton } from '@ionic/angular/standalone';
import { Subscription, firstValueFrom } from 'rxjs';
import { OpenWebsiteService } from 'src/app/services/website/open-website.service';
import { addIcons } from "ionicons";
import { addCircle, ticketOutline, chevronForwardOutline, thumbsUpOutline, receiptOutline, settingsOutline, statsChartOutline, chevronBack, chevronDown, chevronUp, arrowForwardOutline } from "ionicons/icons";
...
export class ProfilePage implements OnInit {
    ...
    constructor(private router: Router, private http: HttpClient, private website: OpenWebsiteService,
        ...
        addIcons({ addCircle, ticketOutline, chevronForwardOutline, thumbsUpOutline, receiptOutline, settingsOutline, statsChartOutline, chevronBack, chevronDown, chevronUp, arrowForwardOutline });
    }
